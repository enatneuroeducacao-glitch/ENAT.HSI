...
export default function CentralENATHSI(){return <BrowserRouter basename={APP_BASENAME}><AuthProvider><Routes><Route path="/" element={<PortalPublicoENAT/>}/><Route path="/portal" element={<PortalPublicoENAT/>}/><Route path="/artigo/:id" element={<ArticleReaderENAT/>}/><Route path="/depoimentos" element={<DepoimentosPublicosENAT/>}/><Route path="/login" element={<LoginENAT/>}/><Route path="/validar/:code" element={<ValidarCertificadoPublico/>}/><Route path="*" element={<PrivateArea/>}/></Routes></AuthProvider></BrowserRouter>}
