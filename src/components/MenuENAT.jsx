      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav>
          <ul className="flex gap-6">
            ...
            <li>
              <NavLink to="/testes" className={({ isActive }) => (isActive ? "text-blue-600 font-medium" : "text-gray-700")}>🧪 Testes</NavLink>
            </li>
            <li>
              <NavLink to="/certificados" className={({ isActive }) => (isActive ? "text-blue-600 font-medium" : "text-gray-700")}>📜 Certificados</NavLink>
            </li>
            <li>
